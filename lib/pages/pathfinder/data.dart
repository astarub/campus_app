...
final Map<dynamic, Map<String, dynamic>> graph = {
  ...
  ('ND', '05', '196'): {
    'Coordinates': [2590, 2791],
    'Connections': [
      (('ND', '05', 'EN_63'), 82),
    ],
  },

  ('ND', '05', 'Treppenhaus-95'): {
    'Coordinates': [2923, 2532],
    'Connections': [
      (('ND', '05', 'EN_64'), 70),
    ],
  },
  ...
  ('ND', '05', 'Aufzug-7'): {
    'Coordinates': [3618, 3583],
    'Connections': [
      (('ND', '05', 'EN_65'), 87),
      (('ND', '05', 'Treppenhaus-7a'), 116),
      (('ND', '05', 'EN_62'), 134),
    ],
  },

  ('ND', '05', 'Treppenhaus-7a'): {
    'Coordinates': [3635, 3698],
    'Connections': [
      (('ND', '05', 'Aufzug-7'), 116),
    ],
  },
  ...
  ('ND', '05', '173'): {
    'Coordinates': [2509, 1883],
    'Connections': [],
  },

  ('ND', '05', '169'): {
    'Coordinates': [2245, 1596],
    'Connections': [
      (('ND', '05', 'EN_81'), 69),
    ],
  },
  ...
  ('ND', '05', '117'): {
    'Coordinates': [878, 1119],
    'Connections': [],
  },

  ('ND', '05', '118'): {
    'Coordinates': [838, 1171],
    'Connections': [
      (('ND', '05', 'EN_92'), 63),
    ],
  },
  ...
  ('ND', '05', 'Aufzug-107'): {
    'Coordinates': [2067, 2130],
    'Connections': [
      (('ND', '05', 'EN_101'), 110),
      (('ND', '05', 'Treppenhaus-107a'), 128),
      (('ND', '05', 'EN_100'), 118),
    ],
  },

  ('ND', '05', 'Treppenhaus-107a'): {
    'Coordinates': [2010, 2015],
    'Connections': [
      (('ND', '05', 'Aufzug-107'), 128),
      (('ND', '04', 'Treppenhaus-7a'), 1),
    ],
  },

  ('ND', '05', '105'): {
    'Coordinates': [2067, 1952],
    'Connections': [
      (('ND', '05', 'EN_101'), 95),
    ],
  },
  ...
  ('ND', '05', 'EN_105'): {
    'Coordinates': [4996, 4180],
    'Connections': [
      (('ND', '05', 'EN_71'), 220),
      (('ND', '05', 'EN_72'), 597),
      (('ND', '05', 'Eingang-Nordstr.'), 188),
    ],
  },

  ('ND', '05', 'EN_71'): {
    'Coordinates': [4824, 4318],
    'Connections': [
      (('ND', '05', '56'), 57),
      (('ND', '05', 'EN_105'), 220),
      (('ND', '05', 'EN_70'), 151),
  ...
  ('ND', '05', 'EN_64'): {
    'Coordinates': [2865, 2572],
    'Connections': [
      (('ND', '05', 'Treppenhaus-95'), 70),
      (('ND', '05', 'EN_109'), 175),
      (('ND', '05', 'EN_111'), 53),
    ],
  },
  ...
  ('ND', '05', 'EN_101'): {
    'Coordinates': [2119, 2032],
    'Connections': [
      (('ND', '05', 'Aufzug-107'), 110),
      (('ND', '05', '105'), 95),
      (('ND', '05', 'EN_113'), 97),
    ],
  },
  ...
  ('ND', '05', 'EN_100'): {
    'Coordinates': [1981, 2211],
    'Connections': [
      (('ND', '05', '106'), 134),
      (('ND', '05', 'Aufzug-107'), 118),
      (('ND', '05', 'EN_115'), 90),
    ],
  },

  ('ND', '05', 'EN_115'): {
    'Coordinates': [1900, 2251],
    'Connections': [
      (('ND', '05', 'EN_100'), 90),
      (('ND', '05', 'EN_99'), 194),
    ],
  ...
  ('ND', '05', 'EN_89'): {
    'Coordinates': [1332, 574],
    'Connections': [
      (('ND', '05', '152'), 101),
      (('ND', '05', 'EN_117'), 287),
      (('ND', '05', 'Brücke-zu-NI'), 390),
    ],
  },

  ('ND', '05', 'EN_86'): {
    'Coordinates': [1211, 694],
    'Connections': [
      (('ND', '05', '160'), 77),
      (('ND', '05', '152'), 69),
      (('ND', '05', 'EN_87'), 77),
  ...
  ('ND', '05', 'Eingang-Nordstr.'): {
    'Coordinates': [5145, 4295],
    'Connections': [
      (('ND', '05', 'EN_105'), 188),
      (('ND', '05', 'EN_104'), 188),
      (('RUB', '0', 'Campus'), 100),
  ...
  ('ND', '04', 'Aufzug-7'): {
    'Coordinates': [4743, 4673],
    'Connections': [
      (('ND', '04', 'EN_107'), 138),
      (('ND', '04', 'Treppenhaus-7a'), 146),
      (('ND', '04', 'EN_108'), 125),
    ],
  },

  ('ND', '04', '6'): {
    'Coordinates': [4758, 4836],
    'Connections': [
      (('ND', '04', 'EN_108'), 94),
    ],
  },

  ('ND', '04', 'Treppenhaus-7a'): {
    'Coordinates': [4867, 4751],
    'Connections': [
      (('ND', '04', 'Aufzug-7'), 146),
    ],
  },
  ...
  ('ND', '04', 'Aufzug-107'): {
    'Coordinates': [2266, 2367],
    'Connections': [
      (('ND', '04', 'EN_120'), 111),
      (('ND', '04', 'Treppenhaus-107a'), 148),
      (('ND', '04', 'EN_121'), 132),
    ],
  },

  ('ND', '04', '106'): {
    'Coordinates': [2088, 2336],
    'Connections': [
      (('ND', '04', 'EN_121'), 140),
    ],
  },
  ...
  ('ND', '04', '105'): {
    'Coordinates': [2243, 2173],
    'Connections': [
      (('ND', '04', 'EN_120'), 116),
    ],
  },

  ('ND', '04', 'Treppenhaus-107a'): {
    'Coordinates': [2197, 2235],
    'Connections': [
      (('ND', '04', 'Aufzug-107'), 148),
    ],
  },

  ('ND', '04', '171c'): {
    'Coordinates': [2499, 2810],
    'Connections': [
      (('ND', '04', 'EN_122'), 110),
    ],
  },
  ...
  ('ND', '04', '131'): {
    'Coordinates': [2274, 2794],
    'Connections': [
      (('ND', '04', 'EN_125'), 76),
    ],
  },

  ('ND', '04', 'EingangNDSüd-1'): {
    'Coordinates': [2282, 1956],
    'Connections': [
      (('ND', '04', 'EN_126'), 211),
    ],
  },

  ('ND', '04', 'EingangNDSüd-2'): {
    'Coordinates': [1770, 2429],
    'Connections': [
      (('ND', '04', 'EN_127'), 292),
    ],
  },
  ...
  ('ND', '04', 'EN_105'): {
    'Coordinates': [3974, 3578],
    'Connections': [
      (('ND', '04', 'EN_132'), 243),
      (('ND', '04', 'Treppenhaus-95'), 153),
      (('ND', '04', '99'), 186),
      (('ND', '04', 'EN_133'), 1038),
    ],
  },
  ...
  ('ND', '04', 'EN_120'): {
    'Coordinates': [2313, 2266],
    'Connections': [
      (('ND', '04', 'EN_134'), 100),
      (('ND', '04', '105'), 116),
      (('ND', '04', 'Aufzug-107'), 111),
    ],
  },

  ('ND', '04', 'EN_121'): {
    'Coordinates': [2165, 2453],
    'Connections': [
      (('ND', '04', 'Aufzug-107'), 132),
      (('ND', '04', '106'), 140),
      (('ND', '04', 'EN_127'), 197),
    ],
  },
  ...
  ('ND', '04', 'EN_127'): {
    'Coordinates': [2018, 2585],
    'Connections': [
      (('ND', '04', 'EN_121'), 197),
      (('ND', '04', 'EingangNDSüd-2'), 292),
      (('ND', '04', 'EN_135'), 140),
    ],
  },

  ('ND', '04', 'EN_135'): {
    'Coordinates': [2158, 2592],
    'Connections': [
      (('ND', '04', 'EN_127'), 140),
      (('ND', '04', 'EN_125'), 197),
    ],
  ...
  ('ND', '04', 'EN_126'): {
    'Coordinates': [2453, 2080],
    'Connections': [
      (('ND', '04', 'EingangNDSüd-1'), 211),
      (('ND', '04', 'EN_134'), 132),
    ],
  },
