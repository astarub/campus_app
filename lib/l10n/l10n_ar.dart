...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get mensaBalanceTitle => 'رصيد الكافتيريا';
  ...
  @override
  String get firebaseDecisionPopup => 'To show you notifactions about spontaneous Events and Dates around campus, we currently use the \nGoogle service Firebase.\n\nIf that is a concern to you, we will respect that.\nWe plan to provide an alternative starting in January.';

  @override
  String get firebaseDecisionPopupSlim => 'To show you notifactions about spontaneous Events and Dates around campus, \nwe currently use the Google service Firebase.\nIf that is a concern to you, we will respect that.\nWe plan to provide an alternative starting in January.';
  ...
  @override
  String get controlRoomButton => 'غرفة التحكم في جامعة بوخوم';

  @override
  String get controlRoomButtonDescription => 'متواجدون دائمًا، لأي حالة طارئة';

  @override
  String get walletAddStudentTicket => 'أضف تذكرة الفصل الدراسي الخاصة بك';
  ...
  @override
  String get faqEmergencyNumberText => 'تمتلك جامعة الرور في بوخوم غرفة مراقبة تعمل على مدار الساعة ويمكن الوصول إليها دائمًا عبر الهاتف. في حالات الطوارئ، يتم إخطار خدمات الإطفاء أو الإسعاف أو الشرطة وكذلك الجهات المعنية في الجامعة. من الأفضل حفظ رقم الطوارئ على هاتفك: 0234 3223333';

  @override
  String get balanceMultipleTags => 'تم العثور على عدة بطاقات NFC! حاول مرة أخرى.';

  @override
  String get balanceIOSScanCard => 'امسح بطاقتك.';

  @override
  String get balanceMensaBalance => 'رصيد الكافتيريا';

  @override
  String get balanceBalance => 'الرصيد: ';

  @override
  String get balanceLastTransaction => 'آخر عملية:';

  @override
  String get balanceScanCard => 'امسح البطاقة';

  @override
  String get balanceScanCardDetailed => 'ضع بطاقة الطالب الخاصة بك قرب هاتفك لمسحها.';

  @override
  String get balanceNFCOff => 'تم تعطيل NFC';

  @override
  String get balanceNFCOffDetailed => 'يجب تفعيل NFC لقراءة رصيد بطاقة AKAFÖ الخاصة بك.';

  @override
  String get balanceLastBalance => 'آخر رصيد: ';

  @override
  String get balanceLastScanned => 'آخر عملية ممسوحة: ';

  @override
  String get ticketLoginLoginID => 'معرف تسجيل الدخول إلى RUB';

  @override
  String get ticketLoginPasswort => 'كلمة مرور RUB';

  @override
  String get ticketLoginLogin => 'تسجيل الدخول';

  @override
  String get ticketLoginBothFieldsError => 'يرجى ملء كلا الحقلين!';

  @override
  String get ticketLoginInternetError => 'تحقق من اتصالك بالإنترنت!';

  @override
  String get ticketLoginWrongDataError => 'معرف الدخول أو كلمة المرور غير صحيحة!';

  @override
  String get ticketLoginLoadingError => 'حدث خطأ أثناء تحميل التذكرة!';

  @override
  String get ticketLoginEncryptedInfo => 'يتم تشفير بياناتك وتخزينها محليًا. يتم إرسالها فقط إلى خوادم RUB عند تسجيل الدخول.';

  @override
  String get walletPageWallet => 'المحفظة';

  @override
  String get walletPageBalance => 'رصيد الكافتيريا';

  @override
  String get walletPageCampusABC => 'قاموس الحرم الجامعي ABC';

  @override
  String get walletPageComingInFuture => 'سيتم توسيع هذا القسم في الإصدارات المستقبلية لدمج أدلة مفيدة.';

  @override
  String get possibleDeviationsNotice => 'قد تحدث تغييرات! يرجى الانتباه إلى الإشعارات في الموقع.';
}
