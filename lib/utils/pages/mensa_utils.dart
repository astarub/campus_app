    ...
    return <MealCategory>[
      MealCategory(
        ...
        meals: [
          ...
          MealItem(
              name: 'veganem Brotaufstrich, Butter, Salat, Gurke und Tomate',
              price: '2,20€',
              onPreferenceTap: onPreferenceTap),
        ],
      ),
      ...
      MealCategory(
        ...
        meals: [
          ...
          MealItem(
              name: 'gekochten Schinken, Tomate, Käse und Remoulade', price: '3,80€', onPreferenceTap: onPreferenceTap),
          MealItem(
              name: 'gekochten Schinken, Ananas, Käse und Remoulade', price: '3,80€', onPreferenceTap: onPreferenceTap),
          MealItem(
              name: 'rohen Schinken, Ananas, Käse und Remoulade', price: '3,80€', onPreferenceTap: onPreferenceTap),
      ...
      MealCategory(
        ...
        meals: [
          MealItem(
              name: 'Regelmäßig wechselnde Kuchenauswahl ohne Sahne', price: '2,20€', onPreferenceTap: onPreferenceTap),
          MealItem(
              name: 'Regelmäßig wechselnde Kuchenauswahl mit Sahne', price: '3,20€', onPreferenceTap: onPreferenceTap),
        ],
      ),
      MealCategory(
      ...
      MealCategory(
        ...
        meals: [
          MealItem(
              name: 'Schokolade, Vanille, Erdbeere oder Haselnuss', price: '1,00€', onPreferenceTap: onPreferenceTap),
      ...
      MealCategory(
        ...
        meals: [
          ...
          MealItem(
              name: 'Grog (Rum mit heissem Wasser, Nur im Winter!)', price: '2,60€', onPreferenceTap: onPreferenceTap),
      ...
      MealCategory(
        ...
        meals: [
          MealItem(
              ...
              onPreferenceTap: onPreferenceTap),
          MealItem(
              name: 'Ginger Ale, Bitter Lemon, Tonic Water', price: '1,80€ / 3,40€', onPreferenceTap: onPreferenceTap),
          MealItem(
