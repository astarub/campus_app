...
class MockCalendarDatasource extends _i1.Mock
  ...
  _i2.Dio get client =>
      (super.noSuchMethod(Invocation.getter(#client), returnValue: _FakeDio_0())
          as _i2.Dio);
  @override
  _i3.Box<dynamic> get eventCach =>
      (super.noSuchMethod(Invocation.getter(#eventCach),
          returnValue: _FakeBox_1<dynamic>()) as _i3.Box<dynamic>);
  @override
  _i5.Future<List<dynamic>> getAStAEventsAsJsonArray() =>
      (super.noSuchMethod(Invocation.method(#getAStAEventsAsJsonArray, []),
              returnValue: Future<List<dynamic>>.value(<dynamic>[]))
          as _i5.Future<List<dynamic>>);
  @override
  _i5.Future<void> writeEventsToCach(List<_i6.Event>? entities) =>
      (super.noSuchMethod(Invocation.method(#writeEventsToCach, [entities]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i5.Future<void>);
  @override
  List<_i6.Event> readEventsFromCach() =>
      (super.noSuchMethod(Invocation.method(#readEventsFromCach, []),
          returnValue: <_i6.Event>[]) as List<_i6.Event>);
}
